...
Examples:
  ...
  scripts/install_easiio_modules.sh --skill class8/keyword-research-skill --skills-target ~/.hermes/skills
  scripts/install_easiio_modules.sh --skill class8/seo-audit-skill --skills-target ~/.hermes/skills
