...
| **Image generation** | Generate images via FAL (9 models: FLUX 2 Klein/Pro, GPT-Image 1.5 & 2, Nano Banana Pro, Ideogram, Recraft V4.1 standard, Qwen, Z-Image) | `FAL_KEY` |
