...
- **[Image Generation](image-generation.md)** — Generate images from text prompts using FAL.ai. Nine models supported (FLUX 2 Klein/Pro, GPT-Image 1.5 & 2, Nano Banana Pro, Ideogram V3, Recraft V4.1 standard, Qwen, Z-Image Turbo); pick one via `hermes tools`.
